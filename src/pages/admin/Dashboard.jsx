    ...
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-4 mb-6">
        <div className="card text-center hover:shadow-lg transition">
          ...
          <Link to="/admin/students" className="text-xs text-blue-500 hover:underline">View all</Link>
        </div>
        <div className="card text-center hover:shadow-lg transition">
          <p className="text-gray-500 text-sm">Total Employees</p>
          <p className="text-2xl font-bold text-primary">{stats.employees}</p>
          <Link to="/admin/employees" className="text-xs text-blue-500 hover:underline">View all</Link>
        </div>
        <div className="card text-center hover:shadow-lg transition">
          <p className="text-gray-500 text-sm">Inventory Value</p>
          <p className="text-2xl font-bold text-green-600">{formatCurrency(stats.inventoryValue)}</p>
          <Link to="/admin/inventory" className="text-xs text-blue-500 hover:underline">Manage</Link>
        </div>
        <div className="card text-center hover:shadow-lg transition">
          <p className="text-gray-500 text-sm">Fees Collected</p>
          <p className="text-2xl font-bold text-green-600">{formatCurrency(stats.feesCollected)}</p>
          <Link to="/admin/fees" className="text-xs text-blue-500 hover:underline">View report</Link>
        </div>
        <div className="card text-center hover:shadow-lg transition">
          <p className="text-gray-500 text-sm">Total Applications</p>
          <p className="text-2xl font-bold text-primary">{stats.applications}</p>
          <Link to="/admin/applications" className="text-xs text-blue-500 hover:underline">Manage</Link>
        </div>
        <div className="card text-center hover:shadow-lg transition">
          <p className="text-gray-500 text-sm">Pending</p>
          <p className="text-2xl font-bold text-yellow-600">{stats.pendingApplications}</p>
          <Link to="/admin/applications" className="text-xs text-blue-500 hover:underline">Review</Link>
        </div>
      </div>
